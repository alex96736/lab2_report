...
DT.import[, month := factor(month, levels = c(0, 1), 
                                    labels = c('Январь-Август',
                                               'Сентябрь-Декабрь'))]
# график за 2010 год
xyplot( ~ Netweight.kg.mean | month, data = DT.import[DT.import$Year==2010],         
      xlab = 'Масса поставки, кг',
      ylab = 'Плотность распределения',        
      main = 'Распределение массы поставки за 2010) 
